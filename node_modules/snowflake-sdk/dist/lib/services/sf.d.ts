 ...
 * @constructor
 */
declare function SnowflakeService(connectionConfig: Object, httpClient: Object, config?: Object): void;
declare class SnowflakeService {
    /**
     * Creates a new SnowflakeService instance.
     *
     * @param {Object} connectionConfig
     ...
     * @constructor
     */
    constructor(connectionConfig: Object, httpClient: Object, config?: Object);
    authenticator: Object;
    /**
     * Set the session id for the current SnowflakeService
     * @type {function(string): void}
     */
    setSessionId: (arg0: string) => void;
    /**
     * Get the session id.
     * @returns {string}
     */
     ...
     */
    transitionToPristine: (transitionContext: any) => void;
    /**
     * Transitions to the Connecting state.
     *
     * {Object} [transitionContext]
     */
    transitionToConnecting: (transitionContext: any) => void;
    /**
     * Transitions to the Connected state.
     *
     * {Object} [transitionContext]
     */
    transitionToConnected: (transitionContext: any) => void;
    /**
     * Transitions to the Renewing state.
     *
     * {Object} [transitionContext]
     */
    transitionToRenewing: (transitionContext: any) => void;
    /**
     * Transitions to the Disconnected state.
     *
     * {Object} [transitionContext]
     */
    transitionToDisconnected: (transitionContext: any) => void;
    /**
     ...
     * @param {Object} options
     */
    requestAsync: (options: Object) => Promise<any>;
    /**
