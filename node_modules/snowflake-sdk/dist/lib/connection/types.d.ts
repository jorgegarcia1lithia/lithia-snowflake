 ...
 */
export type WIP_ConnectionConfig = Pick<WIP_ConnectionOptions, 'token' | 'workloadIdentityProvider' | 'workloadIdentityImpersonationPath' | 'workloadIdentityAzureEntraIdResource' | 'workloadIdentityAzureClientId' | 'oauthEnableSingleUseRefreshTokens' | 'rowStreamHighWaterMark'> & {
    browserRedirectPort: number;
