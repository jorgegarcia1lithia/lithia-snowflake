declare enum ErrorCode {
    ...
    ERR_CONN_CREATE_INVALID_CLIENT_STORE_TEMPORARY_CREDENTIAL = 404049,
    ...
    ERR_CONN_CREATE_MISSING_PASSWORD_AND_TOKEN = 404057,
    ERR_CONN_CREATE_INVALID_OUATH_AUTHORIZATION_URL = 404058,
    ERR_CONN_CREATE_INVALID_OUATH_CLIENT_ID = 404059,
    ERR_CONN_CREATE_INVALID_OUATH_CLIENT_SECRET = 404060,
    ERR_CONN_CREATE_INVALID_OUATH_TOKEN_REQUEST_URL = 404061,
    ERR_CONN_CREATE_INVALID_WORKLOAD_IDENTITY_PARAMETERS = 404062,
    ERR_CONN_CREATE_INVALID_QUERY_TAG = 404063,
    ...
    ERR_CONN_CREATE_INVALID_AUTH_UNSUPPORTED = 405506,
    ERR_CONN_CREATE_AUTH_NOT_ALLOWED = 405507,
    ...
    ERR_CONN_FETCH_RESULT_INVALID_CWD = 410009,
